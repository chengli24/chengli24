...
7. Chen S, Wang K, Pang W, Yang R, Chen Z, Gao R, Lau A, Gu D, Zhang C, Li C<sup>†</sup>. OSDA: A Framework for Open-Set Discovery and Automatic Interpretation of Land-cover in Remote Sensing Imagery. (<sup>†</sup>: Corresponding Author and Team Leader, Under Review now)
